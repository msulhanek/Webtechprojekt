...
function jeDobrePoradie(){
  ...
  if( secondCarCoordinateX < 0 & firstCarCoordinateX < 0 & thirdCarCoordinateY < 0 & poradie.size == 3){
      var pole = [];
      var i = 0;
   ...
   if(pole[1] == 1 & pole[2] == 2){
    document.getElementById('vylustenieKrizovatky').innerHTML = 'Križovatka vyriešená správne, autá sa riadia dopravným značením, električka dostáva prednosť od vľavo odbočujúceho červeného';
   }
   else{
     document.getElementById('vylustenieKrizovatky').innerHTML = 'Križovatka nebola vyriešená správne <br> Nápoveda: Skontroluj dopravné značenie a prednosť električky';
   }
